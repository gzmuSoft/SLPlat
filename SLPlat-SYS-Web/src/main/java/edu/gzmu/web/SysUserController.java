...
public class SysUserController extends BaseController<ISysProvider> {
    ...
    // 用户详细信息
    @ApiOperation(value = "用户详细信息", produces = MediaType.APPLICATION_JSON_VALUE)
    @RequiresPermissions("sys.base.user.read")
    ...
    // 当前用户
    @ApiOperation(value = "当前用户信息", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiOperation(value = "修改用户头像", produces = MediaType.APPLICATION_JSON_VALUE)
